              ...
              {isActive &&
                (recorder.state === "recording" ? (
                  <button
                    ...
                    className="flex h-12 w-12 shrink-0 self-center items-center justify-center rounded-xl bg-[#dc2626] text-white transition-opacity hover:opacity-85"
                  >
                    <StopIcon />
                  </button>
                ) : (
                  <button
                    ...
                    className="bg-ink flex h-12 w-12 shrink-0 self-center items-center justify-center rounded-xl text-white transition-opacity hover:enabled:opacity-80 disabled:opacity-60"
                  >
                    <RecordIcon />
                  </button>
                ))}
